...
function find_winner(){
    ...
    if (study_year == 2023){
        ...
        {name:"Miami",per:'99.92%'}, 
        {name:"Indy State",per:'69.06%'}, 
        {name:"Okla",per:'90.82%'}, 
        {name:"Dayton",per:'80.01%'}, 
        {name:"Memphis",per:'70.91%'}, 
        {name:"Cincy",per:'84.77%'}, 
        {name:"Kentucky",per:'92.38%'}, 
        {name:"UConn",per:'99.98%'}, 
        {name:"Wake F",per:'100.0%'}, 
        {name:"BYU",per:'99.91%'}, 
        {name:"Auburn",per:'100.0%'}, 
        {name:"Colorado",per:'74.75%'}, 
        {name:"H Point",per:'61.78%'}, 
        {name:"Utah St",per:'91.41%'}, 
        {name:"UNC",per:'100.0%'}, 
        {name:"Houston",per:'100.0%'}, 
        {name:"Neb",per:'87.08%'}, 
        {name:"Baylor",per:'99.49%'}, 
        {name:"Duke",per:'51.72%'}, 
        {name:"Creigh",per:'99.47%'}, 
        {name:"Illinois",per:'87.79%'}, 
        {name:"JMU",per:'98.55%'}, 
        {name:"Tenn",per:'64.13%'}, 
        {name:"Kansas",per:'99.98%'}, 
        {name:"Gonzaga",per:'73.91%'}, 
        {name:"GCU",per:'69.82%'}, 
        {name:"UC I",per:'58.28%'}, 
        {name:"New Mex",per:'58.95%'}, 
        {name:"Arizona",per:'99.98%'}, 
        {name:"Alabama",per:'89.16%'}, 
        {name:"Marq",per:'71.31%'}, 
        {name:"Purdue",per:'96.78%'}, 
        {name:"Okla",per:'79.35%'}, 
        {name:"Dayton",per:'52.18%'}, 
        {name:"Kentucky",per:'87.17%'}, 
        {name:"UConn",per:'87.94%'}, 
        {name:"BYU",per:'72.3%'}, 
        {name:"H Point",per:'54.07%'}, 
        {name:"UNC",per:'99.25%'}, 
        {name:"Houston",per:'99.13%'}, 
        {name:"Baylor",per:'72.39%'}, 
        {name:"Illinois",per:'61.42%'}, 
        {name:"Tenn",per:'42.2%'}, 
        {name:"Kansas",per:'72.03%'}, 
        {name:"GCU",per:'65.47%'}, 
        {name:"Arizona",per:'99.51%'}, 
        {name:"Alabama",per:'88.76%'}, 
        {name:"Purdue",per:'88.11%'}, 
        {name:"Kentucky",per:'85.88%'}, 
        {name:"BYU",per:'72.0%'}, 
        {name:"UNC",per:'97.88%'}, 
        {name:"Houston",per:'64.86%'}, 
        {name:"Illinois",per:'30.46%'}, 
        {name:"Kansas",per:'58.83%'}, 
        {name:"Arizona",per:'90.4%'}, 
        {name:"Purdue",per:'76.36%'}, 
        {name:"BYU",per:'61.76%'}, 
        {name:"Houston",per:'63.08%'}, 
        {name:"Arizona",per:'90.06%'}, 
        {name:"BYU",per:'48.24%'}, 
        {name:"Houston",per:'45.54%'}, 
        {name:"Houston",per:'32.98%'}, 
        ];
        var round_32 = [];
        var round_16 = [];
        var round_8 = [];
