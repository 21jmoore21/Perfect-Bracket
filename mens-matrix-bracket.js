...
function find_winner(){
    ...
    if (study_year == 2023){
        ...
        {name:"FAU",per:'99.32%'}, 
        {name:"SDSU",per:'99.76%'}, 
        {name:"Auburn",per:'99.61%'}, 
        {name:"BYU",per:'99.97%'}, 
        {name:"Illinois",per:'73.28%'}, 
        {name:"Drake",per:'94.56%'}, 
        {name:"Iowa St",per:'99.07%'}, 
        {name:"UNC",per:'100.0%'}, 
        {name:"Miss St",per:'74.82%'}, 
        {name:"St Marys",per:'72.28%'}, 
        {name:"Alabama",per:'98.07%'}, 
        {name:"N Mex",per:'77.35%'}, 
        {name:"Baylor",per:'90.03%'}, 
        {name:"Dayton",per:'66.15%'}, 
        {name:"Arizona",per:'100.0%'}, 
        {name:"Houston",per:'97.83%'}, 
        {name:"Neb",per:'95.84%'}, 
        {name:"JMU",per:'99.35%'}, 
        {name:"Duke",per:'97.83%'}, 
        {name:"TTU",per:'99.89%'}, 
        {name:"Kentucky",per:'100.0%'}, 
        {name:"Colorado",per:'90.36%'}, 
        {name:"Marq",per:'53.88%'}, 
        {name:"Purdue",per:'100.0%'}, 
        {name:"Utah St",per:'97.35%'}, 
        {name:"McN",per:'52.08%'}, 
        {name:"Samford",per:'63.97%'}, 
        {name:"S Car",per:'89.13%'}, 
        {name:"Creigh",per:'98.43%'}, 
        {name:"Col St",per:'82.88%'}, 
        {name:"Tenn",per:'100.0%'}, 
        {name:"UConn",per:'100.0%'}, 
        {name:"Auburn",per:'99.5%'}, 
        {name:"Illinois",per:'63.64%'}, 
        {name:"Iowa St",per:'65.28%'}, 
        {name:"UNC",per:'100.0%'}, 
        {name:"St Marys",per:'55.81%'}, 
        {name:"Baylor",per:'54.64%'}, 
        {name:"Arizona",per:'99.51%'}, 
        {name:"Houston",per:'88.83%'}, 
        {name:"JMU",per:'73.34%'}, 
        {name:"Kentucky",per:'97.86%'}, 
        {name:"Colorado",per:'84.86%'}, 
        {name:"Purdue",per:'99.96%'}, 
        {name:"McN",per:'51.94%'}, 
        {name:"Creigh",per:'98.42%'}, 
        {name:"Tenn",per:'99.89%'}, 
        {name:"UConn",per:'77.41%'}, 
        {name:"Illinois",per:'39.23%'}, 
        {name:"UNC",per:'74.66%'}, 
        {name:"Arizona",per:'99.37%'}, 
        {name:"JMU",per:'50.23%'}, 
        {name:"Kentucky",per:'67.61%'}, 
        {name:"Purdue",per:'89.69%'}, 
        {name:"Creigh",per:'60.96%'}, 
        {name:"UConn",per:'72.74%'}, 
        {name:"Arizona",per:'77.45%'}, 
        {name:"JMU",per:'32.14%'}, 
        {name:"Purdue",per:'85.24%'}, 
        {name:"Arizona",per:'59.47%'}, 
        {name:"Purdue",per:'79.18%'}, 
        {name:"Purdue",per:'47.52%'}, 
        ];
        var round_32 = [];
        var round_16 = [];
        var round_8 = [];
