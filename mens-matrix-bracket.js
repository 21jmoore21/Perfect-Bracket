...
function find_winner(){
    ...
    if (study_year == 2023){
        ...
        {name:"FAU",per:'98.27%'}, 
        {name:"SDSU",per:'99.81%'}, 
        {name:"Auburn",per:'99.28%'}, 
        {name:"BYU",per:'99.98%'}, 
        {name:"Illinois",per:'79.69%'}, 
        {name:"Drake",per:'96.34%'}, 
        {name:"Iowa St",per:'99.01%'}, 
        {name:"UNC",per:'100.0%'}, 
        {name:"Miss St",per:'58.46%'}, 
        {name:"St Marys",per:'75.49%'}, 
        {name:"Alabama",per:'95.75%'}, 
        {name:"N Mex",per:'81.21%'}, 
        {name:"Baylor",per:'87.95%'}, 
        {name:"Dayton",per:'59.91%'}, 
        {name:"Arizona",per:'100.0%'}, 
        {name:"Houston",per:'98.49%'}, 
        {name:"Neb",per:'91.93%'}, 
        {name:"JMU",per:'99.37%'}, 
        {name:"Duke",per:'97.41%'}, 
        {name:"TTU",per:'99.38%'}, 
        {name:"Kentucky",per:'100.0%'}, 
        {name:"Colorado",per:'83.3%'}, 
        {name:"Marq",per:'63.85%'}, 
        {name:"Purdue",per:'100.0%'}, 
        {name:"Utah St",per:'98.05%'}, 
        {name:"McN",per:'52.58%'}, 
        {name:"Samford",per:'60.96%'}, 
        {name:"S Car",per:'87.92%'}, 
        {name:"Creigh",per:'98.63%'}, 
        {name:"Col St",per:'86.67%'}, 
        {name:"Tenn",per:'100.0%'}, 
        {name:"UConn",per:'100.0%'}, 
        {name:"Auburn",per:'99.21%'}, 
        {name:"Illinois",per:'68.12%'}, 
        {name:"Iowa St",per:'61.6%'}, 
        {name:"UNC",per:'100.0%'}, 
        {name:"St Marys",per:'57.56%'}, 
        {name:"N Mex",per:'51.35%'}, 
        {name:"Arizona",per:'99.63%'}, 
        {name:"Houston",per:'91.73%'}, 
        {name:"JMU",per:'71.25%'}, 
        {name:"Kentucky",per:'98.23%'}, 
        {name:"Colorado",per:'74.89%'}, 
        {name:"Purdue",per:'99.96%'}, 
        {name:"McN",per:'52.47%'}, 
        {name:"Creigh",per:'98.61%'}, 
        {name:"Tenn",per:'99.86%'}, 
        {name:"UConn",per:'77.36%'}, 
        {name:"Illinois",per:'39.64%'}, 
        {name:"UNC",per:'78.92%'}, 
        {name:"Arizona",per:'99.11%'}, 
        {name:"JMU",per:'45.62%'}, 
        {name:"Kentucky",per:'75.49%'}, 
        {name:"Purdue",per:'84.27%'}, 
        {name:"Creigh",per:'56.37%'}, 
        {name:"UConn",per:'72.82%'}, 
        {name:"Arizona",per:'70.19%'}, 
        {name:"JMU",per:'29.78%'}, 
        {name:"Purdue",per:'80.17%'}, 
        {name:"Arizona",per:'53.37%'}, 
        {name:"Purdue",per:'73.13%'}, 
        {name:"Purdue",per:'42.5%'}, 
        ];
        var round_32 = [];
        var round_16 = [];
        var round_8 = [];
