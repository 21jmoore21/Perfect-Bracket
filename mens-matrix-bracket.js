...
function find_winner(){
    ...
    if (study_year == 2023){
        ...
        {name:"FAU",per:'99.02%'}, 
        {name:"SDSU",per:'99.69%'}, 
        {name:"Auburn",per:'99.57%'}, 
        {name:"BYU",per:'99.99%'}, 
        {name:"Illinois",per:'76.7%'}, 
        {name:"Drake",per:'94.02%'}, 
        {name:"Iowa St",per:'99.06%'}, 
        {name:"UNC",per:'100.0%'}, 
        {name:"Miss St",per:'67.7%'}, 
        {name:"St Marys",per:'75.72%'}, 
        {name:"Alabama",per:'97.64%'}, 
        {name:"N Mex",per:'80.41%'}, 
        {name:"Baylor",per:'90.0%'}, 
        {name:"Dayton",per:'63.97%'}, 
        {name:"Arizona",per:'100.0%'}, 
        ...
        {name:"Colorado",per:'85.66%'}, 
        {name:"Marq",per:'59.2%'}, 
        {name:"Purdue",per:'100.0%'}, 
        {name:"Utah St",per:'96.44%'}, 
        {name:"McN",per:'52.16%'}, 
        {name:"Samford",per:'63.04%'}, 
        {name:"S Car",per:'89.66%'}, 
        {name:"Creigh",per:'98.35%'}, 
        {name:"Col St",per:'81.85%'}, 
        {name:"Tenn",per:'100.0%'}, 
        {name:"UConn",per:'99.99%'}, 
        {name:"Auburn",per:'99.48%'}, 
        {name:"Illinois",per:'66.46%'}, 
        {name:"Iowa St",per:'65.44%'}, 
        {name:"UNC",per:'100.0%'}, 
        {name:"St Marys",per:'58.58%'}, 
        {name:"Baylor",per:'48.73%'}, 
        {name:"Arizona",per:'99.68%'}, 
        {name:"Houston",per:'90.91%'}, 
        {name:"JMU",per:'72.67%'}, 
        {name:"Kentucky",per:'98.13%'}, 
        {name:"Colorado",per:'79.71%'}, 
        {name:"Purdue",per:'99.97%'}, 
        {name:"McN",per:'52.05%'}, 
        {name:"Creigh",per:'98.34%'}, 
        {name:"Tenn",per:'99.93%'}, 
        {name:"UConn",per:'78.79%'}, 
        {name:"Illinois",per:'41.34%'}, 
        {name:"UNC",per:'75.73%'}, 
        {name:"Arizona",per:'99.44%'}, 
        {name:"JMU",per:'46.86%'}, 
        {name:"Kentucky",per:'71.54%'}, 
        {name:"Purdue",per:'87.97%'}, 
        {name:"Creigh",per:'56.49%'}, 
        {name:"UConn",per:'74.77%'}, 
        {name:"Arizona",per:'73.6%'}, 
        {name:"JMU",per:'30.1%'}, 
        {name:"Purdue",per:'83.58%'}, 
        {name:"Arizona",per:'55.45%'}, 
