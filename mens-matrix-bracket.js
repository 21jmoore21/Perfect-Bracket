...
function find_winner(){
    ...
    if (study_year == 2023){
        ...
        {name:"Florida",per:'56.4%'}, 
        {name:"McN",per:'96.97%'}, 
        {name:"Dayton",per:'89.52%'}, 
        {name:"FAU",per:'99.91%'}, 
        {name:"Iowa St",per:'99.05%'}, 
        {name:"Utah St",per:'90.73%'}, 
        {name:"Tenn",per:'98.7%'}, 
        {name:"Arizona",per:'99.84%'}, 
        {name:"Texas",per:'55.12%'}, 
        {name:"BYU",per:'93.19%'}, 
        {name:"UC I",per:'70.61%'}, 
        {name:"Clemson",per:'97.76%'}, 
        {name:"Alabama",per:'81.12%'}, 
        {name:"Col St",per:'97.37%'}, 
        {name:"Kansas",per:'100.0%'}, 
        {name:"UConn",per:'100.0%'}, 
        {name:"Mich St",per:'65.26%'}, 
        {name:"Yale",per:'59.22%'}, 
        {name:"Baylor",per:'99.88%'}, 
        {name:"Indy St",per:'58.63%'}, 
        {name:"Auburn",per:'99.62%'}, 
        {name:"TTU",per:'78.02%'}, 
        {name:"UNC",per:'100.0%'}, 
        {name:"Houston",per:'100.0%'}, 
        {name:"St Marys",per:'99.24%'}, 
        {name:"Creigh",per:'93.29%'}, 
        {name:"Illinois",per:'98.33%'}, 
        {name:"Kentucky",per:'54.63%'}, 
        {name:"Duke",per:'89.71%'}, 
        {name:"TCU",per:'87.71%'}, 
        {name:"Marq",per:'79.03%'}, 
        {name:"Purdue",per:'100.0%'}, 
        {name:"McN",per:'84.0%'}, 
        {name:"Iowa St",per:'89.99%'}, 
        {name:"Tenn",per:'52.2%'}, 
        {name:"Arizona",per:'99.84%'}, 
        {name:"BYU",per:'92.72%'}, 
        {name:"Alabama",per:'81.1%'}, 
        {name:"Kansas",per:'55.48%'}, 
        {name:"UConn",per:'99.82%'}, 
        {name:"Baylor",per:'92.87%'}, 
        {name:"Auburn",per:'64.07%'}, 
        {name:"UNC",per:'99.98%'}, 
        {name:"Houston",per:'93.48%'}, 
        {name:"Illinois",per:'54.55%'}, 
        {name:"Duke",per:'47.79%'}, 
        {name:"Marq",per:'63.34%'}, 
        {name:"Purdue",per:'92.47%'}, 
        {name:"Iowa St",per:'59.07%'}, 
        {name:"Arizona",per:'93.25%'}, 
        {name:"Alabama",per:'77.4%'}, 
        {name:"UConn",per:'92.66%'}, 
        {name:"UNC",per:'67.46%'}, 
        {name:"Houston",per:'69.82%'}, 
        {name:"Duke",per:'47.64%'}, 
        {name:"Purdue",per:'91.54%'}, 
        {name:"Arizona",per:'86.36%'}, 
        {name:"UNC",per:'55.04%'}, 
        {name:"Houston",per:'56.97%'}, 
        {name:"Purdue",per:'72.62%'}, 
        {name:"UNC",per:'38.27%'}, 
        {name:"Purdue",per:'60.94%'}, 
        ];
        var round_32 = [];
        var round_16 = [];
        var round_8 = [];
