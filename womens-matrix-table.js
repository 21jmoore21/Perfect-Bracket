...
function find_winner(){
    ...
    if (study_year == 2023){
      ...
      var team_stats = [{name:"South Carolina Gamecocks",Round_of_32:'100.0%',Sweet_Sixteen:'99.98%',Elite_Eight:'99.98%',Final_Four:'99.82%',Championship:'93.48%',Champion:'80.73%'}, 
      {name:"LSU Tigers",Round_of_32:'100.0%',Sweet_Sixteen:'99.36%',Elite_Eight:'76.49%',Final_Four:'60.37%',Championship:'50.58%',Champion:'9.69%'}, 
      {name:"Iowa Hawkeyes",Round_of_32:'99.97%',Sweet_Sixteen:'99.06%',Elite_Eight:'97.74%',Final_Four:'24.94%',Championship:'19.1%',Champion:'5.39%'}, 
      {name:"Gonzaga Bulldogs",Round_of_32:'100.0%',Sweet_Sixteen:'99.69%',Elite_Eight:'60.58%',Final_Four:'52.56%',Championship:'5.54%',Champion:'2.6%'}, 
      {name:"UNLV Lady Rebels",Round_of_32:'100.0%',Sweet_Sixteen:'93.53%',Elite_Eight:'23.5%',Final_Four:'14.68%',Championship:'8.3%',Champion:'1.28%'}, 
      {name:"UConn Huskies",Round_of_32:'99.17%',Sweet_Sixteen:'99.17%',Elite_Eight:'99.14%',Final_Four:'99.11%',Championship:'22.01%',Champion:'0.21%'}, 
      {name:"Texas Longhorns",Round_of_32:'100.0%',Sweet_Sixteen:'99.74%',Elite_Eight:'39.36%',Final_Four:'36.1%',Championship:'0.78%',Champion:'0.06%'}, 
      {name:"Stanford Cardinal",Round_of_32:'99.24%',Sweet_Sixteen:'99.21%',Elite_Eight:'91.15%',Final_Four:'9.41%',Championship:'0.13%',Champion:'0.03%'}, 
      {name:"NC State Wolfpack",Round_of_32:'97.54%',Sweet_Sixteen:'79.16%',Elite_Eight:'7.18%',Final_Four:'1.91%',Championship:'0.01%',Champion:'0.01%'}, 
      {name:"Notre Dame Fighting Irish",Round_of_32:'100.0%',Sweet_Sixteen:'100.0%',Elite_Eight:'99.15%',Final_Four:'0.16%',Championship:'0.06%',Champion:'0.0%'}, 
      {name:"Jackson State Lady Tigers",Round_of_32:'0.83%',Sweet_Sixteen:'0.83%',Elite_Eight:'0.83%',Final_Four:'0.83%',Championship:'0.01%',Champion:'0.0%'}, 
      {name:"Ohio State Buckeyes",Round_of_32:'99.54%',Sweet_Sixteen:'75.91%',Elite_Eight:'0.03%',Final_Four:'0.03%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"South Dakota State Jackrabbits",Round_of_32:'40.04%',Sweet_Sixteen:'0.3%',Elite_Eight:'0.04%',Final_Four:'0.02%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Michigan State Spartans",Round_of_32:'99.44%',Sweet_Sixteen:'0.02%',Elite_Eight:'0.02%',Final_Four:'0.02%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Baylor Bears",Round_of_32:'100.0%',Sweet_Sixteen:'72.86%',Elite_Eight:'49.27%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"USC Trojans",Round_of_32:'95.45%',Sweet_Sixteen:'95.45%',Elite_Eight:'38.72%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Kansas State Wildcats",Round_of_32:'100.0%',Sweet_Sixteen:'66.02%',Elite_Eight:'1.55%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Marshall Thundering Herd",Round_of_32:'13.22%',Sweet_Sixteen:'2.16%',Elite_Eight:'1.06%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Virginia Tech Hokies",Round_of_32:'86.78%',Sweet_Sixteen:'24.98%',Elite_Eight:'9.95%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Texas A&M-Corpus Christi Islanders",Round_of_32:'4.55%',Sweet_Sixteen:'4.55%',Elite_Eight:'1.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Green Bay Phoenix",Round_of_32:'95.73%',Sweet_Sixteen:'20.23%',Elite_Eight:'0.97%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Oregon State Beavers",Round_of_32:'83.48%',Sweet_Sixteen:'75.92%',Elite_Eight:'0.85%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"West Virginia Mountaineers",Round_of_32:'92.14%',Sweet_Sixteen:'0.93%',Elite_Eight:'0.7%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Norfolk State Spartans",Round_of_32:'0.76%',Sweet_Sixteen:'0.76%',Elite_Eight:'0.5%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Chattanooga Mocs",Round_of_32:'2.46%',Sweet_Sixteen:'0.61%',Elite_Eight:'0.18%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Florida State Seminoles",Round_of_32:'43.28%',Sweet_Sixteen:'0.26%',Elite_Eight:'0.02%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Drake Bulldogs",Round_of_32:'58.64%',Sweet_Sixteen:'27.57%',Elite_Eight:'0.01%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"UCLA Bruins",Round_of_32:'95.03%',Sweet_Sixteen:'6.47%',Elite_Eight:'0.01%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Maryland Terrapins",Round_of_32:'46.99%',Sweet_Sixteen:'0.02%',Elite_Eight:'0.01%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Iowa State Cyclones",Round_of_32:'53.01%',Sweet_Sixteen:'0.01%',Elite_Eight:'0.01%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Indiana Hoosiers",Round_of_32:'86.92%',Sweet_Sixteen:'63.78%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Florida Gulf Coast Eagles",Round_of_32:'96.42%',Sweet_Sixteen:'31.84%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Richmond Spiders",Round_of_32:'92.51%',Sweet_Sixteen:'23.53%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Eastern Washington Eagles",Round_of_32:'16.52%',Sweet_Sixteen:'14.44%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Nebraska Cornhuskers",Round_of_32:'97.18%',Sweet_Sixteen:'9.59%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Colorado Buffaloes",Round_of_32:'41.36%',Sweet_Sixteen:'6.41%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Fairfield Stags",Round_of_32:'13.08%',Sweet_Sixteen:'4.13%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Middle Tennessee Blue Raiders",Round_of_32:'92.8%',Sweet_Sixteen:'0.64%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Duke Blue Devils",Round_of_32:'7.49%',Sweet_Sixteen:'0.34%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Oklahoma Sooners",Round_of_32:'3.58%',Sweet_Sixteen:'0.25%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Maine Black Bears",Round_of_32:'0.46%',Sweet_Sixteen:'0.22%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Texas A&M Aggies",Round_of_32:'2.82%',Sweet_Sixteen:'0.05%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Utah Utes",Round_of_32:'59.96%',Sweet_Sixteen:'0.01%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Holy Cross Crusaders",Round_of_32:'0.03%',Sweet_Sixteen:'0.01%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Syracuse Orange",Round_of_32:'91.52%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Marquette Golden Eagles",Round_of_32:'74.77%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Michigan Wolverines",Round_of_32:'69.53%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Alabama Crimson Tide",Round_of_32:'56.72%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Kansas Jayhawks",Round_of_32:'30.47%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Ole Miss Rebels",Round_of_32:'25.23%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Auburn Tigers",Round_of_32:'8.48%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Princeton Tigers",Round_of_32:'7.86%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Louisville Cardinals",Round_of_32:'7.2%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"California Baptist Lancers",Round_of_32:'4.97%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Tennessee Lady Volunteers",Round_of_32:'4.27%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"North Carolina Tar Heels",Round_of_32:'0.56%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Sacred Heart Pioneers",Round_of_32:'0.0%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
