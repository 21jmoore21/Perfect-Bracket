...
function find_winner(){
    ...
    if (study_year == 2023){
      ...
      var team_stats = [{name:"South Carolina Gamecocks",Round_of_32:'100.0%',Sweet_Sixteen:'99.99%',Elite_Eight:'99.98%',Final_Four:'99.65%',Championship:'93.37%',Champion:'81.38%'}, 
      {name:"LSU Tigers",Round_of_32:'100.0%',Sweet_Sixteen:'99.33%',Elite_Eight:'77.15%',Final_Four:'60.45%',Championship:'50.51%',Champion:'9.21%'}, 
      {name:"Iowa Hawkeyes",Round_of_32:'99.95%',Sweet_Sixteen:'98.95%',Elite_Eight:'97.58%',Final_Four:'25.06%',Championship:'18.82%',Champion:'5.15%'}, 
      {name:"Gonzaga Bulldogs",Round_of_32:'100.0%',Sweet_Sixteen:'99.7%',Elite_Eight:'60.45%',Final_Four:'52.04%',Championship:'5.7%',Champion:'2.83%'}, 
      {name:"UNLV Lady Rebels",Round_of_32:'99.98%',Sweet_Sixteen:'92.99%',Elite_Eight:'22.84%',Final_Four:'14.48%',Championship:'8.02%',Champion:'1.13%'}, 
      {name:"UConn Huskies",Round_of_32:'99.17%',Sweet_Sixteen:'99.17%',Elite_Eight:'99.17%',Final_Four:'99.14%',Championship:'22.64%',Champion:'0.17%'}, 
      {name:"Texas Longhorns",Round_of_32:'100.0%',Sweet_Sixteen:'99.73%',Elite_Eight:'39.48%',Final_Four:'36.27%',Championship:'0.65%',Champion:'0.06%'}, 
      {name:"Stanford Cardinal",Round_of_32:'99.23%',Sweet_Sixteen:'99.15%',Elite_Eight:'91.4%',Final_Four:'9.82%',Championship:'0.15%',Champion:'0.06%'}, 
      {name:"UCLA Bruins",Round_of_32:'95.13%',Sweet_Sixteen:'7.0%',Elite_Eight:'0.01%',Final_Four:'0.01%',Championship:'0.01%',Champion:'0.01%'}, 
      {name:"Notre Dame Fighting Irish",Round_of_32:'100.0%',Sweet_Sixteen:'100.0%',Elite_Eight:'99.06%',Final_Four:'0.33%',Championship:'0.11%',Champion:'0.0%'}, 
      {name:"NC State Wolfpack",Round_of_32:'97.94%',Sweet_Sixteen:'79.52%',Elite_Eight:'7.02%',Final_Four:'1.82%',Championship:'0.02%',Champion:'0.0%'}, 
      {name:"Jackson State Lady Tigers",Round_of_32:'0.83%',Sweet_Sixteen:'0.83%',Elite_Eight:'0.83%',Final_Four:'0.82%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Norfolk State Spartans",Round_of_32:'0.77%',Sweet_Sixteen:'0.76%',Elite_Eight:'0.59%',Final_Four:'0.03%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"South Dakota State Jackrabbits",Round_of_32:'40.02%',Sweet_Sixteen:'0.3%',Elite_Eight:'0.05%',Final_Four:'0.02%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Baylor Bears",Round_of_32:'100.0%',Sweet_Sixteen:'72.73%',Elite_Eight:'49.5%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"USC Trojans",Round_of_32:'95.21%',Sweet_Sixteen:'95.21%',Elite_Eight:'38.66%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Marshall Thundering Herd",Round_of_32:'13.74%',Sweet_Sixteen:'2.45%',Elite_Eight:'1.38%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Texas A&M-Corpus Christi Islanders",Round_of_32:'4.79%',Sweet_Sixteen:'4.79%',Elite_Eight:'0.7%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Indiana Hoosiers",Round_of_32:'85.94%',Sweet_Sixteen:'63.19%',Elite_Eight:'0.01%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Michigan State Spartans",Round_of_32:'99.33%',Sweet_Sixteen:'0.01%',Elite_Eight:'0.01%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Virginia Tech Hokies",Round_of_32:'86.26%',Sweet_Sixteen:'24.82%',Elite_Eight:'9.76%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Kansas State Wildcats",Round_of_32:'100.0%',Sweet_Sixteen:'66.31%',Elite_Eight:'1.76%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Oregon State Beavers",Round_of_32:'82.54%',Sweet_Sixteen:'75.1%',Elite_Eight:'0.94%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Green Bay Phoenix",Round_of_32:'95.48%',Sweet_Sixteen:'19.82%',Elite_Eight:'0.83%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"West Virginia Mountaineers",Round_of_32:'92.19%',Sweet_Sixteen:'1.0%',Elite_Eight:'0.66%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Chattanooga Mocs",Round_of_32:'2.06%',Sweet_Sixteen:'0.65%',Elite_Eight:'0.11%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Maryland Terrapins",Round_of_32:'47.95%',Sweet_Sixteen:'0.08%',Elite_Eight:'0.04%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Florida State Seminoles",Round_of_32:'42.8%',Sweet_Sixteen:'0.27%',Elite_Eight:'0.02%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Iowa State Cyclones",Round_of_32:'52.05%',Sweet_Sixteen:'0.01%',Elite_Eight:'0.01%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Ohio State Buckeyes",Round_of_32:'99.57%',Sweet_Sixteen:'75.86%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Florida Gulf Coast Eagles",Round_of_32:'96.32%',Sweet_Sixteen:'31.8%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Drake Bulldogs",Round_of_32:'59.51%',Sweet_Sixteen:'28.3%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Richmond Spiders",Round_of_32:'92.44%',Sweet_Sixteen:'23.51%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Eastern Washington Eagles",Round_of_32:'17.46%',Sweet_Sixteen:'15.34%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Nebraska Cornhuskers",Round_of_32:'96.87%',Sweet_Sixteen:'9.5%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Colorado Buffaloes",Round_of_32:'40.49%',Sweet_Sixteen:'5.39%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Fairfield Stags",Round_of_32:'14.06%',Sweet_Sixteen:'4.7%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Middle Tennessee Blue Raiders",Round_of_32:'92.52%',Sweet_Sixteen:'0.67%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Duke Blue Devils",Round_of_32:'7.56%',Sweet_Sixteen:'0.48%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Oklahoma Sooners",Round_of_32:'3.68%',Sweet_Sixteen:'0.31%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Maine Black Bears",Round_of_32:'0.43%',Sweet_Sixteen:'0.15%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Texas A&M Aggies",Round_of_32:'3.13%',Sweet_Sixteen:'0.06%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Holy Cross Crusaders",Round_of_32:'0.05%',Sweet_Sixteen:'0.04%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Princeton Tigers",Round_of_32:'7.81%',Sweet_Sixteen:'0.01%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Tennessee Lady Volunteers",Round_of_32:'4.52%',Sweet_Sixteen:'0.01%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Creighton Bluejays",Round_of_32:'0.02%',Sweet_Sixteen:'0.01%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Syracuse Orange",Round_of_32:'90.94%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Marquette Golden Eagles",Round_of_32:'74.45%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Michigan Wolverines",Round_of_32:'69.78%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Utah Utes",Round_of_32:'59.98%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Alabama Crimson Tide",Round_of_32:'57.2%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Kansas Jayhawks",Round_of_32:'30.22%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Ole Miss Rebels",Round_of_32:'25.55%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Auburn Tigers",Round_of_32:'9.06%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Louisville Cardinals",Round_of_32:'7.48%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"California Baptist Lancers",Round_of_32:'4.87%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"North Carolina Tar Heels",Round_of_32:'0.67%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Sacred Heart Pioneers",Round_of_32:'0.0%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      ...
      {name:"Portland Pilots",Round_of_32:'0.0%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
