...
function find_winner(){
    ...
    if (study_year == 2023){
      ...
      var team_stats = [{name:"South Carolina Gamecocks",Round_of_32:'100.0%',Sweet_Sixteen:'100.0%',Elite_Eight:'99.99%',Final_Four:'99.85%',Championship:'93.33%',Champion:'80.07%'}, 
      {name:"LSU Tigers",Round_of_32:'100.0%',Sweet_Sixteen:'99.31%',Elite_Eight:'77.39%',Final_Four:'62.75%',Championship:'53.16%',Champion:'10.55%'}, 
      {name:"Iowa Hawkeyes",Round_of_32:'99.92%',Sweet_Sixteen:'98.72%',Elite_Eight:'97.16%',Final_Four:'22.87%',Championship:'17.12%',Champion:'4.75%'}, 
      {name:"Gonzaga Bulldogs",Round_of_32:'100.0%',Sweet_Sixteen:'99.65%',Elite_Eight:'59.69%',Final_Four:'50.55%',Championship:'5.65%',Champion:'2.93%'}, 
      {name:"UNLV Lady Rebels",Round_of_32:'99.99%',Sweet_Sixteen:'92.45%',Elite_Eight:'22.61%',Final_Four:'14.38%',Championship:'7.24%',Champion:'1.26%'}, 
      {name:"UConn Huskies",Round_of_32:'99.05%',Sweet_Sixteen:'99.05%',Elite_Eight:'99.05%',Final_Four:'98.95%',Championship:'22.48%',Champion:'0.31%'}, 
      {name:"Texas Longhorns",Round_of_32:'100.0%',Sweet_Sixteen:'99.54%',Elite_Eight:'40.17%',Final_Four:'36.5%',Championship:'0.75%',Champion:'0.07%'}, 
      {name:"Stanford Cardinal",Round_of_32:'98.91%',Sweet_Sixteen:'98.89%',Elite_Eight:'89.49%',Final_Four:'10.43%',Championship:'0.18%',Champion:'0.06%'}, 
      {name:"Notre Dame Fighting Irish",Round_of_32:'100.0%',Sweet_Sixteen:'100.0%',Elite_Eight:'98.98%',Final_Four:'0.14%',Championship:'0.06%',Champion:'0.0%'}, 
      {name:"NC State Wolfpack",Round_of_32:'97.56%',Sweet_Sixteen:'83.21%',Elite_Eight:'8.75%',Final_Four:'2.48%',Championship:'0.03%',Champion:'0.0%'}, 
      {name:"Jackson State Lady Tigers",Round_of_32:'0.95%',Sweet_Sixteen:'0.95%',Elite_Eight:'0.95%',Final_Four:'0.94%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Baylor Bears",Round_of_32:'100.0%',Sweet_Sixteen:'78.71%',Elite_Eight:'55.26%',Final_Four:'0.07%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"South Dakota State Jackrabbits",Round_of_32:'41.96%',Sweet_Sixteen:'0.34%',Elite_Eight:'0.12%',Final_Four:'0.04%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Marshall Thundering Herd",Round_of_32:'13.72%',Sweet_Sixteen:'1.66%',Elite_Eight:'1.16%',Final_Four:'0.03%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"USC Trojans",Round_of_32:'93.95%',Sweet_Sixteen:'93.95%',Elite_Eight:'34.26%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Indiana Hoosiers",Round_of_32:'84.18%',Sweet_Sixteen:'62.64%',Elite_Eight:'0.01%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Virginia Tech Hokies",Round_of_32:'86.28%',Sweet_Sixteen:'19.63%',Elite_Eight:'8.16%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Kansas State Wildcats",Round_of_32:'100.0%',Sweet_Sixteen:'66.39%',Elite_Eight:'2.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Texas A&M-Corpus Christi Islanders",Round_of_32:'6.05%',Sweet_Sixteen:'6.05%',Elite_Eight:'1.16%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Oregon State Beavers",Round_of_32:'84.3%',Sweet_Sixteen:'76.51%',Elite_Eight:'1.02%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"West Virginia Mountaineers",Round_of_32:'92.92%',Sweet_Sixteen:'1.24%',Elite_Eight:'0.84%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Norfolk State Spartans",Round_of_32:'1.09%',Sweet_Sixteen:'1.09%',Elite_Eight:'0.84%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Green Bay Phoenix",Round_of_32:'94.05%',Sweet_Sixteen:'16.05%',Elite_Eight:'0.8%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Chattanooga Mocs",Round_of_32:'2.44%',Sweet_Sixteen:'0.74%',Elite_Eight:'0.1%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Florida State Seminoles",Round_of_32:'39.5%',Sweet_Sixteen:'0.46%',Elite_Eight:'0.02%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Maryland Terrapins",Round_of_32:'45.14%',Sweet_Sixteen:'0.02%',Elite_Eight:'0.02%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Ohio State Buckeyes",Round_of_32:'99.48%',Sweet_Sixteen:'73.39%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Florida Gulf Coast Eagles",Round_of_32:'95.83%',Sweet_Sixteen:'32.1%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Drake Bulldogs",Round_of_32:'63.89%',Sweet_Sixteen:'29.34%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Richmond Spiders",Round_of_32:'91.59%',Sweet_Sixteen:'25.91%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Eastern Washington Eagles",Round_of_32:'15.7%',Sweet_Sixteen:'13.8%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Nebraska Cornhuskers",Round_of_32:'96.84%',Sweet_Sixteen:'9.63%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"UCLA Bruins",Round_of_32:'94.7%',Sweet_Sixteen:'7.53%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Fairfield Stags",Round_of_32:'15.82%',Sweet_Sixteen:'5.05%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Colorado Buffaloes",Round_of_32:'36.11%',Sweet_Sixteen:'4.27%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Middle Tennessee Blue Raiders",Round_of_32:'91.42%',Sweet_Sixteen:'0.69%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Duke Blue Devils",Round_of_32:'8.41%',Sweet_Sixteen:'0.49%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Oklahoma Sooners",Round_of_32:'4.17%',Sweet_Sixteen:'0.21%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Maine Black Bears",Round_of_32:'0.52%',Sweet_Sixteen:'0.21%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Texas A&M Aggies",Round_of_32:'3.16%',Sweet_Sixteen:'0.06%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Holy Cross Crusaders",Round_of_32:'0.08%',Sweet_Sixteen:'0.04%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Utah Utes",Round_of_32:'58.04%',Sweet_Sixteen:'0.01%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"California Baptist Lancers",Round_of_32:'5.3%',Sweet_Sixteen:'0.01%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Creighton Bluejays",Round_of_32:'0.01%',Sweet_Sixteen:'0.01%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Syracuse Orange",Round_of_32:'100.0%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Michigan State Spartans",Round_of_32:'99.24%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Marquette Golden Eagles",Round_of_32:'73.98%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Michigan Wolverines",Round_of_32:'69.64%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Alabama Crimson Tide",Round_of_32:'60.5%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Iowa State Cyclones",Round_of_32:'54.86%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Kansas Jayhawks",Round_of_32:'30.36%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Ole Miss Rebels",Round_of_32:'26.02%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Louisville Cardinals",Round_of_32:'8.58%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Princeton Tigers",Round_of_32:'7.08%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Tennessee Lady Volunteers",Round_of_32:'5.95%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"North Carolina Tar Heels",Round_of_32:'0.76%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      ...
      {name:"Arizona Wildcats",Round_of_32:'0.0%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      ];
    }
    let team_id = "team_";
