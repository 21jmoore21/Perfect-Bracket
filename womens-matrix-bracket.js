...
function find_winner(){
    ...
    if (study_year == 2023){
        ...
        {name:"Maine",per:'-'}, 
        {name:"S Car",per:'100.0%'}, 
        {name:"Mich St",per:'99.33%'}, 
        {name:"FGCU",per:'96.32%'}, 
        {name:"Indiana",per:'85.94%'}, 
        {name:"Neb",per:'96.87%'}, 
        {name:"Or St",per:'82.54%'}, 
        {name:"Marq",per:'74.45%'}, 
        {name:"N Dame",per:'100.0%'}, 
        {name:"Texas",per:'100.0%'}, 
        {name:"Alabama",per:'57.2%'}, 
        {name:"Utah",per:'59.98%'}, 
        {name:"Gonzaga",per:'100.0%'}, 
        {name:"GB",per:'95.48%'}, 
        {name:"NC St",per:'97.94%'}, 
        {name:"Iowa St",per:'52.05%'}, 
        {name:"Stanford",per:'99.23%'}, 
        {name:"Iowa",per:'99.95%'}, 
        {name:"WVU",per:'92.19%'}, 
        {name:"Drake",per:'59.51%'}, 
        {name:"K State",per:'100.0%'}, 
        {name:"Mid Tenn",per:'92.52%'}, 
        {name:"LSU",per:'100.0%'}, 
        {name:"UNLV",per:'99.98%'}, 
        {name:"UCLA",per:'95.13%'}, 
        {name:"USC",per:'95.21%'}, 
        {name:"Michigan",per:'69.78%'}, 
        {name:"Baylor",per:'100.0%'}, 
        {name:"VA Tech",per:'86.26%'}, 
        {name:"Syracuse",per:'90.94%'}, 
        {name:"UConn",per:'99.17%'}, 
        {name:"Rich",per:'92.44%'}, 
        {name:"Ohio St",per:'99.57%'}, 
        {name:"S Car",per:'99.99%'}, 
        {name:"Indiana",per:'63.19%'}, 
        {name:"Or St",per:'75.1%'}, 
        {name:"N Dame",per:'100.0%'}, 
        {name:"Texas",per:'99.73%'}, 
        {name:"Gonzaga",per:'99.7%'}, 
        {name:"NC St",per:'79.52%'}, 
        {name:"Stanford",per:'99.15%'}, 
        {name:"Iowa",per:'98.95%'}, 
        {name:"K State",per:'66.31%'}, 
        {name:"LSU",per:'99.33%'}, 
        {name:"UNLV",per:'92.99%'}, 
        {name:"USC",per:'95.21%'}, 
        {name:"Baylor",per:'72.73%'}, 
        {name:"UConn",per:'99.17%'}, 
        {name:"Ohio St",per:'75.86%'}, 
        {name:"S Car",per:'99.98%'}, 
        {name:"N Dame",per:'99.06%'}, 
        {name:"Gonzaga",per:'60.45%'}, 
        {name:"Stanford",per:'91.4%'}, 
        {name:"Iowa",per:'97.58%'}, 
        {name:"LSU",per:'77.15%'}, 
        {name:"Baylor",per:'49.5%'}, 
        {name:"UConn",per:'99.17%'}, 
        {name:"S Car",per:'99.65%'}, 
        {name:"Gonzaga",per:'52.04%'}, 
        {name:"LSU",per:'60.45%'}, 
        {name:"UConn",per:'99.14%'}, 
        {name:"S Car",per:'93.37%'}, 
        {name:"LSU",per:'50.51%'}, 
        {name:"S Car",per:'81.38%'}, 
        ];
        var round_32 = [];
        var round_16 = [];
        var round_8 = [];
