...
function find_winner(){
    ...
    if (study_year == 2023){
        ...
        {name:"Wyo",per:'-'}, 
        {name:"S Car",per:'100.0%'}, 
        {name:"Mich St",per:'99.79%'}, 
        {name:"Utah",per:'99.99%'}, 
        {name:"Gonzaga",per:'95.04%'}, 
        {name:"UNC",per:'55.74%'}, 
        {name:"UConn",per:'100.0%'}, 
        {name:"UNLV",per:'99.48%'}, 
        {name:"USC",per:'99.95%'}, 
        {name:"Stanford",per:'100.0%'}, 
        {name:"Alabama",per:'92.7%'}, 
        {name:"S Brook",per:'76.36%'}, 
        {name:"Indiana",per:'98.54%'}, 
        {name:"Creigh",per:'66.59%'}, 
        {name:"Texas",per:'100.0%'}, 
        {name:"Vandy",per:'100.0%'}, 
        {name:"NC St",per:'100.0%'}, 
        {name:"UCLA",per:'100.0%'}, 
        {name:"Texas AM",per:'63.78%'}, 
        {name:"Ohio St",per:'99.93%'}, 
        {name:"Louis",per:'92.75%'}, 
        {name:"N Dame",per:'100.0%'}, 
        {name:"K State",per:'99.93%'}, 
        {name:"Neb",per:'99.99%'}, 
        {name:"LSU",per:'100.0%'}, 
        {name:"Iowa",per:'100.0%'}, 
        {name:"Syracuse",per:'90.0%'}, 
        {name:"Or St",per:'99.91%'}, 
        {name:"VA Tech",per:'100.0%'}, 
        {name:"Marq",per:'90.95%'}, 
        {name:"Baylor",per:'100.0%'}, 
        {name:"WVU",per:'72.22%'}, 
        {name:"Colorado",per:'99.96%'}, 
        {name:"S Car",per:'99.91%'}, 
        {name:"Utah",per:'99.77%'}, 
        {name:"UConn",per:'99.9%'}, 
        {name:"UNLV",per:'80.4%'}, 
        {name:"Stanford",per:'99.28%'}, 
        {name:"S Brook",per:'59.6%'}, 
        {name:"Texas",per:'99.95%'}, 
        {name:"NC St",per:'99.96%'}, 
        {name:"UCLA",per:'91.97%'}, 
        {name:"Ohio St",per:'68.47%'}, 
        {name:"N Dame",per:'88.61%'}, 
        {name:"LSU",per:'100.0%'}, 
        {name:"Iowa",per:'99.7%'}, 
        {name:"VA Tech",per:'95.14%'}, 
        {name:"Baylor",per:'99.82%'}, 
        {name:"WVU",per:'62.45%'}, 
        {name:"S Car",per:'99.26%'}, 
        {name:"UNLV",per:'58.15%'}, 
        {name:"Stanford",per:'99.22%'}, 
        {name:"Texas",per:'78.55%'}, 
        {name:"UCLA",per:'85.59%'}, 
        {name:"LSU",per:'98.11%'}, 
        {name:"Iowa",per:'86.75%'}, 
        {name:"Baylor",per:'97.33%'}, 
        {name:"S Car",per:'99.05%'}, 
        {name:"Stanford",per:'69.2%'}, 
        {name:"LSU",per:'97.29%'}, 
        {name:"Iowa",per:'76.12%'}, 
        {name:"S Car",per:'85.07%'}, 
        {name:"LSU",per:'92.6%'}, 
        {name:"S Car",per:'59.34%'}, 
        ];
        var round_32 = [];
        var round_16 = [];
        var round_8 = [];
