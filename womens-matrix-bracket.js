...
function find_winner(){
    ...
    if (study_year == 2023){
        ...
        {name:"Maine",per:'-'}, 
        {name:"S Car",per:'100.0%'}, 
        {name:"Mich St",per:'99.44%'}, 
        {name:"FGCU",per:'96.42%'}, 
        {name:"Indiana",per:'86.92%'}, 
        {name:"Neb",per:'97.18%'}, 
        {name:"Or St",per:'83.48%'}, 
        {name:"Marq",per:'74.77%'}, 
        {name:"N Dame",per:'100.0%'}, 
        {name:"Texas",per:'100.0%'}, 
        {name:"Alabama",per:'56.72%'}, 
        {name:"Utah",per:'59.96%'}, 
        {name:"Gonzaga",per:'100.0%'}, 
        {name:"GB",per:'95.73%'}, 
        {name:"NC St",per:'97.54%'}, 
        {name:"Iowa St",per:'53.01%'}, 
        {name:"Stanford",per:'99.24%'}, 
        {name:"Iowa",per:'99.97%'}, 
        {name:"WVU",per:'92.14%'}, 
        {name:"Drake",per:'58.64%'}, 
        {name:"K State",per:'100.0%'}, 
        {name:"Mid Tenn",per:'92.8%'}, 
        {name:"LSU",per:'100.0%'}, 
        {name:"UNLV",per:'100.0%'}, 
        {name:"UCLA",per:'95.03%'}, 
        {name:"USC",per:'95.45%'}, 
        {name:"Michigan",per:'69.53%'}, 
        {name:"Baylor",per:'100.0%'}, 
        {name:"VA Tech",per:'86.78%'}, 
        {name:"Syracuse",per:'91.52%'}, 
        {name:"UConn",per:'99.17%'}, 
        {name:"Rich",per:'92.51%'}, 
        {name:"Ohio St",per:'99.54%'}, 
        {name:"S Car",per:'99.98%'}, 
        {name:"Indiana",per:'63.78%'}, 
        {name:"Or St",per:'75.92%'}, 
        {name:"N Dame",per:'100.0%'}, 
        {name:"Texas",per:'99.74%'}, 
        {name:"Gonzaga",per:'99.69%'}, 
        {name:"NC St",per:'79.16%'}, 
        {name:"Stanford",per:'99.21%'}, 
        {name:"Iowa",per:'99.06%'}, 
        {name:"K State",per:'66.02%'}, 
        {name:"LSU",per:'99.36%'}, 
        {name:"UNLV",per:'93.53%'}, 
        {name:"USC",per:'95.45%'}, 
        {name:"Baylor",per:'72.86%'}, 
        {name:"UConn",per:'99.17%'}, 
        {name:"Ohio St",per:'75.91%'}, 
        {name:"S Car",per:'99.98%'}, 
        {name:"N Dame",per:'99.15%'}, 
        {name:"Gonzaga",per:'60.58%'}, 
        {name:"Stanford",per:'91.15%'}, 
        {name:"Iowa",per:'97.74%'}, 
        {name:"LSU",per:'76.49%'}, 
        {name:"Baylor",per:'49.27%'}, 
        {name:"UConn",per:'99.14%'}, 
        {name:"S Car",per:'99.82%'}, 
        {name:"Gonzaga",per:'52.56%'}, 
        {name:"LSU",per:'60.37%'}, 
        {name:"UConn",per:'99.11%'}, 
        {name:"S Car",per:'93.48%'}, 
        {name:"LSU",per:'50.58%'}, 
        {name:"S Car",per:'80.73%'}, 
        ];
        var round_32 = [];
        var round_16 = [];
        var round_8 = [];
