...
function find_winner(){
    ...
    if (study_year == 2023){
        ...
        {name:"Maine",per:'-'}, 
        {name:"S Car",per:'100.0%'}, 
        {name:"Mich St",per:'99.26%'}, 
        {name:"FGCU",per:'95.91%'}, 
        {name:"Indiana",per:'83.1%'}, 
        {name:"Neb",per:'96.52%'}, 
        {name:"Or St",per:'83.42%'}, 
        {name:"Marq",per:'73.43%'}, 
        {name:"N Dame",per:'100.0%'}, 
        {name:"Texas",per:'100.0%'}, 
        {name:"Alabama",per:'62.01%'}, 
        {name:"Utah",per:'56.5%'}, 
        {name:"Gonzaga",per:'100.0%'}, 
        {name:"GB",per:'94.49%'}, 
        {name:"NC St",per:'97.48%'}, 
        {name:"Iowa St",per:'54.47%'}, 
        {name:"Stanford",per:'98.78%'}, 
        {name:"Iowa",per:'99.94%'}, 
        {name:"WVU",per:'93.47%'}, 
        {name:"Drake",per:'62.47%'}, 
        {name:"K State",per:'99.99%'}, 
        {name:"Mid Tenn",per:'91.2%'}, 
        {name:"LSU",per:'100.0%'}, 
        {name:"UNLV",per:'100.0%'}, 
        {name:"UCLA",per:'95.09%'}, 
        {name:"USC",per:'93.49%'}, 
        {name:"Michigan",per:'70.23%'}, 
        {name:"Baylor",per:'100.0%'}, 
        {name:"VA Tech",per:'85.38%'}, 
        {name:"Syracuse",per:'89.12%'}, 
        {name:"UConn",per:'98.87%'}, 
        {name:"Rich",per:'91.11%'}, 
        {name:"Ohio St",per:'99.43%'}, 
        {name:"S Car",per:'99.98%'}, 
        {name:"Indiana",per:'62.28%'}, 
        {name:"Or St",per:'75.76%'}, 
        {name:"N Dame",per:'100.0%'}, 
        {name:"Texas",per:'99.7%'}, 
        {name:"Gonzaga",per:'99.63%'}, 
        {name:"NC St",per:'82.97%'}, 
        {name:"Stanford",per:'98.74%'}, 
        {name:"Iowa",per:'98.66%'}, 
        {name:"K State",per:'67.2%'}, 
        {name:"LSU",per:'99.46%'}, 
        {name:"UNLV",per:'92.06%'}, 
        {name:"USC",per:'93.49%'}, 
        {name:"Baylor",per:'78.08%'}, 
        {name:"UConn",per:'98.87%'}, 
        {name:"Ohio St",per:'74.47%'}, 
        {name:"S Car",per:'99.98%'}, 
        {name:"N Dame",per:'99.14%'}, 
        {name:"Gonzaga",per:'59.16%'}, 
        {name:"Stanford",per:'90.12%'}, 
        {name:"Iowa",per:'96.95%'}, 
        {name:"LSU",per:'79.59%'}, 
        {name:"Baylor",per:'54.43%'}, 
        {name:"UConn",per:'98.83%'}, 
        {name:"S Car",per:'99.83%'}, 
        {name:"Gonzaga",per:'51.0%'}, 
        {name:"LSU",per:'64.64%'}, 
        {name:"UConn",per:'98.77%'}, 
        {name:"S Car",per:'93.93%'}, 
        {name:"LSU",per:'54.24%'}, 
        {name:"S Car",per:'80.45%'}, 
        ];
        var round_32 = [];
        var round_16 = [];
        var round_8 = [];
