...
function find_winner(){
    ...
    if (study_year == 2023){
        ...
        var round_32 = ['S Car', 'USF', 'Okla', 'UCLA', 'Miss St', 'N Dame', 'Arizona', 'Maryland', 'Stanford', 'Ole Miss', 'Louis', 'Texas', 'Colorado', 'Duke', 'Georgia', 'Iowa', 'Indiana', 'Miami', 'FGCU', 'Villa', 'Michigan', 'LSU', 'Prince', 'Utah', 'VA Tech', 'S Dak St', 'Toledo', 'Tenn', 'UNC', 'Ohio St', 'Baylor', 'UConn'];
        var round_16 = ['S Car', 'UCLA', 'N Dame', 'Maryland', 'Ole Miss', 'Louis', 'Colorado', 'Iowa', 'Miami', 'Villa', 'LSU', 'Utah', 'VA Tech', 'Tenn', 'Ohio St', 'UConn'];
        var round_8 = ['S Car', 'Maryland', 'Louis', 'Iowa', 'Miami', 'LSU', 'VA Tech', 'Ohio St'];
        ...
        var round_32 = ['S Car', 'Miami', 'UNC', 'Arizona', 'Georgia', 'Iowa St', 'Creigh', 'Iowa', 'Louis', 'Gonzaga', 'Belmont', 'Tenn', 'Villa', 'Michigan', 'S Dak', 'Baylor', 'Stanford', 'Kansas', 'FGCU', 'Maryland', 'Ohio St', 'LSU', 'Utah', 'Texas', 'NC St', 'K State', 'N Dame', 'Okla', 'Prince', 'Indiana', 'UCF', 'UConn'];
        var round_16 = ['S Car', 'UNC', 'Iowa St', 'Creigh', 'Louis', 'Tenn', 'Michigan', 'S Dak', 'Stanford', 'Maryland', 'Ohio St', 'Texas', 'NC St', 'N Dame', 'Indiana', 'UConn'];
        ...
        {name:"Maryland",per:'99.19%'}, 
        {name:"UConn",per:'99.96%'}, 
        {name:"Baylor",per:'99.54%'}, 
        {name:"NC St",per:'83.66%'}, 
        {name:"Texas AM",per:'73.71%'}, 
        {name:"Stanford",per:'95.75%'}, 
        {name:"Maryland",per:'55.36%'}, 
        {name:"UConn",per:'84.23%'}, 
        {name:"NC St",per:'73.86%'}, 
        {name:"Maryland",per:'46.21%'}, 
        {name:"UConn",per:'84.23%'}, 
        {name:"UConn",per:'75.4%'}, 
        ];
        var round_32 = ['Stanford', 'Okla St', 'Mizz St', 'Wright St', 'Oregon', 'Georgia', 'NWest', 'Louis', 'S Car', 'Or St', 'GA Tech', 'WVU', 'Texas', 'UCLA', 'Alabama', 'Maryland', 'UConn', 'Syracuse', 'Iowa', 'Kentucky', 'Michigan', 'Tenn', 'VA Tech', 'Baylor', 'NC St','USF', 'Belmont', 'Indiana', 'BYU', 'Arizona', 'Iowa St', 'Texas AM'];
        var round_16 = ['Stanford', 'Mizz St', 'Oregon', 'Louis', 'S Car', 'GA Tech', 'Texas', 'Maryland', 'UConn', 'Iowa', 'Michigan', 'Baylor', 'NC St', 'Indiana', 'Arizona', 'Texas AM'];
