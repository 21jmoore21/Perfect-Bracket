...
function find_winner(){
    ...
    if (study_year == 2023){
      ...
      var team_stats = [{name:"Purdue Boilermakers",Round_of_32:'100.0%',Sweet_Sixteen:'99.96%',Elite_Eight:'84.27%',Final_Four:'80.17%',Championship:'73.13%',Champion:'42.5%'}, 
      {name:"Arizona Wildcats",Round_of_32:'100.0%',Sweet_Sixteen:'99.63%',Elite_Eight:'99.11%',Final_Four:'70.19%',Championship:'53.37%',Champion:'24.56%'}, 
      {name:"UConn Huskies",Round_of_32:'100.0%',Sweet_Sixteen:'100.0%',Elite_Eight:'77.36%',Final_Four:'72.82%',Championship:'23.2%',Champion:'8.49%'}, 
      {name:"McNeese Cowboys",Round_of_32:'52.58%',Sweet_Sixteen:'52.47%',Elite_Eight:'13.36%',Final_Four:'12.91%',Championship:'8.54%',Champion:'5.62%'}, 
      {name:"North Carolina Tar Heels",Round_of_32:'100.0%',Sweet_Sixteen:'100.0%',Elite_Eight:'78.92%',Final_Four:'22.21%',Championship:'11.23%',Champion:'5.52%'}, 
      {name:"Houston Cougars",Round_of_32:'98.49%',Sweet_Sixteen:'91.73%',Elite_Eight:'36.92%',Final_Four:'32.2%',Championship:'8.54%',Champion:'4.32%'}, 
      {name:"Auburn Tigers",Round_of_32:'99.28%',Sweet_Sixteen:'99.21%',Elite_Eight:'22.63%',Final_Four:'20.86%',Championship:'8.73%',Champion:'4.21%'}, 
      {name:"Creighton Bluejays",Round_of_32:'98.63%',Sweet_Sixteen:'98.61%',Elite_Eight:'56.37%',Final_Four:'4.31%',Championship:'3.55%',Champion:'1.51%'}, 
      {name:"Kentucky Wildcats",Round_of_32:'100.0%',Sweet_Sixteen:'98.23%',Elite_Eight:'75.49%',Final_Four:'27.62%',Championship:'2.5%',Champion:'1.26%'}, 
      {name:"Saint Mary's Gaels",Round_of_32:'75.49%',Sweet_Sixteen:'57.56%',Elite_Eight:'13.89%',Final_Four:'5.65%',Championship:'2.56%',Champion:'1.14%'}, 
      {name:"James Madison Dukes",Round_of_32:'99.37%',Sweet_Sixteen:'71.25%',Elite_Eight:'45.62%',Final_Four:'29.78%',Championship:'2.74%',Champion:'0.65%'}, 
      {name:"Alabama Crimson Tide",Round_of_32:'95.75%',Sweet_Sixteen:'32.55%',Elite_Eight:'5.55%',Final_Four:'1.34%',Championship:'0.43%',Champion:'0.13%'}, 
      {name:"Gonzaga Bulldogs",Round_of_32:'47.42%',Sweet_Sixteen:'47.33%',Elite_Eight:'2.36%',Final_Four:'1.39%',Championship:'0.86%',Champion:'0.05%'}, 
      {name:"Iowa State Cyclones",Round_of_32:'99.01%',Sweet_Sixteen:'61.6%',Elite_Eight:'35.12%',Final_Four:'3.03%',Championship:'0.39%',Champion:'0.02%'}, 
      {name:"Morehead State Eagles",Round_of_32:'20.31%',Sweet_Sixteen:'16.75%',Elite_Eight:'8.25%',Final_Four:'0.15%',Championship:'0.02%',Champion:'0.01%'}, 
      {name:"Drake Bulldogs",Round_of_32:'96.34%',Sweet_Sixteen:'38.38%',Elite_Eight:'13.55%',Final_Four:'2.0%',Championship:'0.01%',Champion:'0.01%'}, 
      {name:"Tennessee Volunteers",Round_of_32:'100.0%',Sweet_Sixteen:'99.86%',Elite_Eight:'43.61%',Final_Four:'1.21%',Championship:'0.12%',Champion:'0.0%'}, 
      {name:"Grand Canyon Lopes",Round_of_32:'24.51%',Sweet_Sixteen:'9.86%',Elite_Eight:'1.64%',Final_Four:'0.41%',Championship:'0.03%',Champion:'0.0%'}, 
      {name:"Colorado Buffaloes",Round_of_32:'83.3%',Sweet_Sixteen:'74.89%',Elite_Eight:'21.67%',Final_Four:'4.98%',Championship:'0.02%',Champion:'0.0%'}, 
      {name:"Dayton Flyers",Round_of_32:'59.91%',Sweet_Sixteen:'0.3%',Elite_Eight:'0.3%',Final_Four:'0.09%',Championship:'0.02%',Champion:'0.0%'}, 
      {name:"New Mexico Lobos",Round_of_32:'81.21%',Sweet_Sixteen:'51.35%',Elite_Eight:'0.49%',Final_Four:'0.1%',Championship:'0.01%',Champion:'0.0%'}, 
      {name:"Duke Blue Devils",Round_of_32:'97.41%',Sweet_Sixteen:'28.49%',Elite_Eight:'17.27%',Final_Four:'5.26%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Illinois Fighting Illini",Round_of_32:'79.69%',Sweet_Sixteen:'68.12%',Elite_Eight:'39.64%',Final_Four:'1.14%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Vermont Catamounts",Round_of_32:'2.59%',Sweet_Sixteen:'0.25%',Elite_Eight:'0.16%',Final_Four:'0.12%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Florida Gators",Round_of_32:'16.7%',Sweet_Sixteen:'12.62%',Elite_Eight:'1.5%',Final_Four:'0.04%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Baylor Bears",Round_of_32:'87.95%',Sweet_Sixteen:'42.6%',Elite_Eight:'0.02%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Utah State Aggies",Round_of_32:'98.05%',Sweet_Sixteen:'0.04%',Elite_Eight:'0.01%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"BYU Cougars",Round_of_32:'99.98%',Sweet_Sixteen:'15.13%',Elite_Eight:'3.44%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Western Kentucky Hilltoppers",Round_of_32:'36.15%',Sweet_Sixteen:'1.35%',Elite_Eight:'0.76%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Marquette Golden Eagles",Round_of_32:'63.85%',Sweet_Sixteen:'11.14%',Elite_Eight:'0.4%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Texas Tech Red Raiders",Round_of_32:'99.38%',Sweet_Sixteen:'1.77%',Elite_Eight:'0.18%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Nevada Wolf Pack",Round_of_32:'40.09%',Sweet_Sixteen:'0.07%',Elite_Eight:'0.07%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Nebraska Cornhuskers",Round_of_32:'91.93%',Sweet_Sixteen:'7.19%',Elite_Eight:'0.02%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Akron Zips",Round_of_32:'1.37%',Sweet_Sixteen:'1.37%',Elite_Eight:'0.02%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Colgate Raiders",Round_of_32:'12.05%',Sweet_Sixteen:'1.28%',Elite_Eight:'0.01%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Yale Bulldogs",Round_of_32:'0.72%',Sweet_Sixteen:'0.72%',Elite_Eight:'0.01%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Wisconsin Badgers",Round_of_32:'0.63%',Sweet_Sixteen:'0.01%',Elite_Eight:'0.01%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Clemson Tigers",Round_of_32:'18.79%',Sweet_Sixteen:'4.77%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Longwood Lancers",Round_of_32:'1.51%',Sweet_Sixteen:'0.88%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Samford Bulldogs",Round_of_32:'60.96%',Sweet_Sixteen:'0.2%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Texas A&M Aggies",Round_of_32:'8.07%',Sweet_Sixteen:'0.2%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Colorado State Rams",Round_of_32:'86.67%',Sweet_Sixteen:'0.14%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"San Diego State Aztecs",Round_of_32:'99.81%',Sweet_Sixteen:'0.07%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Charleston Cougars",Round_of_32:'4.25%',Sweet_Sixteen:'0.03%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Washington State Cougars",Round_of_32:'3.66%',Sweet_Sixteen:'0.02%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"South Carolina Gamecocks",Round_of_32:'87.92%',Sweet_Sixteen:'0.01%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Oregon Ducks",Round_of_32:'12.08%',Sweet_Sixteen:'0.01%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Florida Atlantic Owls",Round_of_32:'98.27%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Mississippi State Bulldogs",Round_of_32:'58.46%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Michigan State Spartans",Round_of_32:'41.54%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Kansas Jayhawks",Round_of_32:'39.04%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Texas Longhorns",Round_of_32:'13.33%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"TCU Horned Frogs",Round_of_32:'1.95%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Northwestern Wildcats",Round_of_32:'1.73%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"South Dakota State Jackrabbits",Round_of_32:'0.99%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"NC State Wolfpack",Round_of_32:'0.62%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"UAB Blazers",Round_of_32:'0.19%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Duquesne Dukes",Round_of_32:'0.02%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
