...
function find_winner(){
    ...
    if (study_year == 2023){
      ...
      var team_stats = [{name:"Purdue Boilermakers",Round_of_32:'100.0%',Sweet_Sixteen:'99.92%',Elite_Eight:'89.29%',Final_Four:'84.74%',Championship:'78.73%',Champion:'47.3%'}, 
      {name:"Arizona Wildcats",Round_of_32:'100.0%',Sweet_Sixteen:'99.64%',Elite_Eight:'99.46%',Final_Four:'77.43%',Championship:'59.92%',Champion:'26.62%'}, 
      {name:"UConn Huskies",Round_of_32:'100.0%',Sweet_Sixteen:'100.0%',Elite_Eight:'79.84%',Final_Four:'74.62%',Championship:'21.87%',Champion:'7.44%'}, 
      {name:"McNeese Cowboys",Round_of_32:'52.8%',Sweet_Sixteen:'52.55%',Elite_Eight:'10.01%',Final_Four:'9.56%',Championship:'6.61%',Champion:'4.04%'}, 
      {name:"North Carolina Tar Heels",Round_of_32:'100.0%',Sweet_Sixteen:'100.0%',Elite_Eight:'75.02%',Final_Four:'14.85%',Championship:'7.9%',Champion:'3.34%'}, 
      {name:"Auburn Tigers",Round_of_32:'99.47%',Sweet_Sixteen:'99.33%',Elite_Eight:'20.15%',Final_Four:'18.32%',Championship:'6.7%',Champion:'3.34%'}, 
      {name:"Houston Cougars",Round_of_32:'97.71%',Sweet_Sixteen:'88.17%',Elite_Eight:'32.06%',Final_Four:'27.67%',Championship:'5.87%',Champion:'2.99%'}, 
      {name:"Creighton Bluejays",Round_of_32:'98.44%',Sweet_Sixteen:'98.43%',Elite_Eight:'60.23%',Final_Four:'4.64%',Championship:'4.11%',Champion:'1.9%'}, 
      {name:"Saint Mary's Gaels",Round_of_32:'70.6%',Sweet_Sixteen:'54.5%',Elite_Eight:'15.12%',Final_Four:'5.36%',Championship:'2.23%',Champion:'1.16%'}, 
      {name:"Kentucky Wildcats",Round_of_32:'99.99%',Sweet_Sixteen:'97.79%',Elite_Eight:'66.27%',Final_Four:'27.71%',Championship:'2.1%',Champion:'1.01%'}, 
      {name:"James Madison Dukes",Round_of_32:'99.24%',Sweet_Sixteen:'72.96%',Elite_Eight:'49.9%',Final_Four:'31.78%',Championship:'2.29%',Champion:'0.61%'}, 
      {name:"Alabama Crimson Tide",Round_of_32:'97.83%',Sweet_Sixteen:'32.87%',Elite_Eight:'7.33%',Final_Four:'1.7%',Championship:'0.65%',Champion:'0.19%'}, 
      {name:"Iowa State Cyclones",Round_of_32:'99.0%',Sweet_Sixteen:'64.81%',Elite_Eight:'35.59%',Final_Four:'3.34%',Championship:'0.58%',Champion:'0.05%'}, 
      {name:"Colorado Buffaloes",Round_of_32:'87.26%',Sweet_Sixteen:'82.43%',Elite_Eight:'30.68%',Final_Four:'7.59%',Championship:'0.01%',Champion:'0.01%'}, 
      {name:"Gonzaga Bulldogs",Round_of_32:'47.2%',Sweet_Sixteen:'47.15%',Elite_Eight:'0.7%',Final_Four:'0.3%',Championship:'0.18%',Champion:'0.0%'}, 
      {name:"Tennessee Volunteers",Round_of_32:'100.0%',Sweet_Sixteen:'99.89%',Elite_Eight:'39.76%',Final_Four:'0.76%',Championship:'0.1%',Champion:'0.0%'}, 
      {name:"Grand Canyon Lopes",Round_of_32:'29.4%',Sweet_Sixteen:'12.63%',Elite_Eight:'2.53%',Final_Four:'0.44%',Championship:'0.06%',Champion:'0.0%'}, 
      {name:"Morehead State Eagles",Round_of_32:'24.96%',Sweet_Sixteen:'21.7%',Elite_Eight:'11.22%',Final_Four:'0.34%',Championship:'0.04%',Champion:'0.0%'}, 
      {name:"Dayton Flyers",Round_of_32:'65.73%',Sweet_Sixteen:'0.33%',Elite_Eight:'0.33%',Final_Four:'0.19%',Championship:'0.04%',Champion:'0.0%'}, 
      {name:"Baylor Bears",Round_of_32:'89.95%',Sweet_Sixteen:'54.27%',Elite_Eight:'0.02%',Final_Four:'0.01%',Championship:'0.01%',Champion:'0.0%'}, 
      {name:"Duke Blue Devils",Round_of_32:'97.39%',Sweet_Sixteen:'26.87%',Elite_Eight:'17.9%',Final_Four:'5.1%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Drake Bulldogs",Round_of_32:'94.66%',Sweet_Sixteen:'35.17%',Elite_Eight:'10.51%',Final_Four:'1.93%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Illinois Fighting Illini",Round_of_32:'75.04%',Sweet_Sixteen:'66.27%',Elite_Eight:'39.57%',Final_Four:'1.45%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Vermont Catamounts",Round_of_32:'2.61%',Sweet_Sixteen:'0.17%',Elite_Eight:'0.13%',Final_Four:'0.09%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Florida Gators",Round_of_32:'12.74%',Sweet_Sixteen:'10.96%',Elite_Eight:'1.75%',Final_Four:'0.05%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"New Mexico Lobos",Round_of_32:'77.24%',Sweet_Sixteen:'39.49%',Elite_Eight:'0.17%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Texas Tech Red Raiders",Round_of_32:'99.93%',Sweet_Sixteen:'2.21%',Elite_Eight:'0.15%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Nevada Wolf Pack",Round_of_32:'34.27%',Sweet_Sixteen:'0.03%',Elite_Eight:'0.02%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"BYU Cougars",Round_of_32:'100.0%',Sweet_Sixteen:'12.03%',Elite_Eight:'3.11%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Western Kentucky Hilltoppers",Round_of_32:'46.09%',Sweet_Sixteen:'1.47%',Elite_Eight:'0.79%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Marquette Golden Eagles",Round_of_32:'53.91%',Sweet_Sixteen:'5.14%',Elite_Eight:'0.36%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Nebraska Cornhuskers",Round_of_32:'95.61%',Sweet_Sixteen:'10.41%',Elite_Eight:'0.01%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Akron Zips",Round_of_32:'1.56%',Sweet_Sixteen:'1.54%',Elite_Eight:'0.01%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Yale Bulldogs",Round_of_32:'0.53%',Sweet_Sixteen:'0.52%',Elite_Eight:'0.01%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Clemson Tigers",Round_of_32:'22.76%',Sweet_Sixteen:'4.4%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Colgate Raiders",Round_of_32:'10.05%',Sweet_Sixteen:'1.84%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Longwood Lancers",Round_of_32:'2.29%',Sweet_Sixteen:'1.3%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Samford Bulldogs",Round_of_32:'63.31%',Sweet_Sixteen:'0.3%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"San Diego State Aztecs",Round_of_32:'99.78%',Sweet_Sixteen:'0.15%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Texas A&M Aggies",Round_of_32:'4.39%',Sweet_Sixteen:'0.12%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Colorado State Rams",Round_of_32:'82.34%',Sweet_Sixteen:'0.11%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Utah State Aggies",Round_of_32:'96.99%',Sweet_Sixteen:'0.08%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"South Carolina Gamecocks",Round_of_32:'88.67%',Sweet_Sixteen:'0.03%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Washington State Cougars",Round_of_32:'5.34%',Sweet_Sixteen:'0.02%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Florida Atlantic Owls",Round_of_32:'99.28%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Mississippi State Bulldogs",Round_of_32:'74.38%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Kansas Jayhawks",Round_of_32:'36.69%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Michigan State Spartans",Round_of_32:'25.62%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Texas Longhorns",Round_of_32:'17.66%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Oregon Ducks",Round_of_32:'11.33%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"TCU Horned Frogs",Round_of_32:'3.01%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Charleston Cougars",Round_of_32:'2.17%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"South Dakota State Jackrabbits",Round_of_32:'1.0%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Wisconsin Badgers",Round_of_32:'0.76%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Northwestern Wildcats",Round_of_32:'0.72%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"UAB Blazers",Round_of_32:'0.22%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"NC State Wolfpack",Round_of_32:'0.07%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Oakland Golden Grizzlies",Round_of_32:'0.01%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Stetson Hatters",Round_of_32:'0.0%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Duquesne Dukes",Round_of_32:'0.0%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
