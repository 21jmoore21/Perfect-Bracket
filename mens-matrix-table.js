...
function find_winner(){
    ...
    if (study_year == 2023){
      ...
      var team_stats = [{name:"Purdue Boilermakers",Round_of_32:'100.0%',Sweet_Sixteen:'99.96%',Elite_Eight:'89.69%',Final_Four:'85.24%',Championship:'79.18%',Champion:'47.52%'}, 
      {name:"Arizona Wildcats",Round_of_32:'100.0%',Sweet_Sixteen:'99.51%',Elite_Eight:'99.37%',Final_Four:'77.45%',Championship:'59.47%',Champion:'26.74%'}, 
      {name:"UConn Huskies",Round_of_32:'100.0%',Sweet_Sixteen:'100.0%',Elite_Eight:'77.41%',Final_Four:'72.74%',Championship:'21.32%',Champion:'7.01%'}, 
      {name:"McNeese Cowboys",Round_of_32:'52.08%',Sweet_Sixteen:'51.94%',Elite_Eight:'9.63%',Final_Four:'9.37%',Championship:'6.52%',Champion:'4.23%'}, 
      {name:"Auburn Tigers",Round_of_32:'99.61%',Sweet_Sixteen:'99.5%',Elite_Eight:'22.58%',Final_Four:'20.65%',Championship:'8.24%',Champion:'3.84%'}, 
      {name:"North Carolina Tar Heels",Round_of_32:'100.0%',Sweet_Sixteen:'100.0%',Elite_Eight:'74.66%',Final_Four:'15.01%',Championship:'7.62%',Champion:'3.21%'}, 
      {name:"Houston Cougars",Round_of_32:'97.83%',Sweet_Sixteen:'88.83%',Elite_Eight:'31.83%',Final_Four:'27.65%',Championship:'5.54%',Champion:'2.8%'}, 
      {name:"Creighton Bluejays",Round_of_32:'98.43%',Sweet_Sixteen:'98.42%',Elite_Eight:'60.96%',Final_Four:'4.32%',Championship:'3.8%',Champion:'1.81%'}, 
      {name:"Kentucky Wildcats",Round_of_32:'100.0%',Sweet_Sixteen:'97.86%',Elite_Eight:'67.61%',Final_Four:'27.9%',Championship:'2.28%',Champion:'1.03%'}, 
      {name:"Saint Mary's Gaels",Round_of_32:'72.28%',Sweet_Sixteen:'55.81%',Elite_Eight:'15.64%',Final_Four:'5.12%',Championship:'2.18%',Champion:'0.99%'}, 
      {name:"James Madison Dukes",Round_of_32:'99.35%',Sweet_Sixteen:'73.34%',Elite_Eight:'50.23%',Final_Four:'32.14%',Championship:'2.41%',Champion:'0.57%'}, 
      {name:"Alabama Crimson Tide",Round_of_32:'98.07%',Sweet_Sixteen:'32.23%',Elite_Eight:'7.18%',Final_Four:'1.6%',Championship:'0.59%',Champion:'0.22%'}, 
      {name:"Iowa State Cyclones",Round_of_32:'99.07%',Sweet_Sixteen:'65.28%',Elite_Eight:'35.14%',Final_Four:'3.27%',Championship:'0.45%',Champion:'0.01%'}, 
      {name:"Gonzaga Bulldogs",Round_of_32:'47.92%',Sweet_Sixteen:'47.77%',Elite_Eight:'0.66%',Final_Four:'0.29%',Championship:'0.15%',Champion:'0.01%'}, 
      {name:"Grand Canyon Lopes",Round_of_32:'27.72%',Sweet_Sixteen:'11.96%',Elite_Eight:'2.52%',Final_Four:'0.6%',Championship:'0.05%',Champion:'0.01%'}, 
      {name:"Tennessee Volunteers",Round_of_32:'100.0%',Sweet_Sixteen:'99.89%',Elite_Eight:'38.97%',Final_Four:'0.76%',Championship:'0.12%',Champion:'0.0%'}, 
      {name:"Dayton Flyers",Round_of_32:'66.15%',Sweet_Sixteen:'0.42%',Elite_Eight:'0.42%',Final_Four:'0.16%',Championship:'0.06%',Champion:'0.0%'}, 
      {name:"Illinois Fighting Illini",Round_of_32:'73.28%',Sweet_Sixteen:'63.64%',Elite_Eight:'39.23%',Final_Four:'1.45%',Championship:'0.01%',Champion:'0.0%'}, 
      {name:"Morehead State Eagles",Round_of_32:'26.72%',Sweet_Sixteen:'22.29%',Elite_Eight:'11.08%',Final_Four:'0.33%',Championship:'0.01%',Champion:'0.0%'}, 
      {name:"Colorado Buffaloes",Round_of_32:'90.36%',Sweet_Sixteen:'84.86%',Elite_Eight:'29.74%',Final_Four:'7.2%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Duke Blue Devils",Round_of_32:'97.83%',Sweet_Sixteen:'26.47%',Elite_Eight:'17.72%',Final_Four:'4.92%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Drake Bulldogs",Round_of_32:'94.56%',Sweet_Sixteen:'34.72%',Elite_Eight:'10.59%',Final_Four:'1.56%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Vermont Catamounts",Round_of_32:'2.17%',Sweet_Sixteen:'0.19%',Elite_Eight:'0.18%',Final_Four:'0.12%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Florida Gators",Round_of_32:'9.64%',Sweet_Sixteen:'7.99%',Elite_Eight:'1.08%',Final_Four:'0.07%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"New Mexico Lobos",Round_of_32:'77.35%',Sweet_Sixteen:'39.17%',Elite_Eight:'0.13%',Final_Four:'0.04%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Nevada Wolf Pack",Round_of_32:'33.85%',Sweet_Sixteen:'0.07%',Elite_Eight:'0.06%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Baylor Bears",Round_of_32:'90.03%',Sweet_Sixteen:'54.64%',Elite_Eight:'0.02%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Samford Bulldogs",Round_of_32:'63.97%',Sweet_Sixteen:'0.29%',Elite_Eight:'0.01%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Utah State Aggies",Round_of_32:'97.35%',Sweet_Sixteen:'0.04%',Elite_Eight:'0.01%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"BYU Cougars",Round_of_32:'99.97%',Sweet_Sixteen:'14.07%',Elite_Eight:'3.96%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Western Kentucky Hilltoppers",Round_of_32:'46.12%',Sweet_Sixteen:'1.78%',Elite_Eight:'1.01%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Marquette Golden Eagles",Round_of_32:'53.88%',Sweet_Sixteen:'5.37%',Elite_Eight:'0.29%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Texas Tech Red Raiders",Round_of_32:'99.89%',Sweet_Sixteen:'2.14%',Elite_Eight:'0.27%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Akron Zips",Round_of_32:'1.57%',Sweet_Sixteen:'1.56%',Elite_Eight:'0.07%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Nebraska Cornhuskers",Round_of_32:'95.84%',Sweet_Sixteen:'9.81%',Elite_Eight:'0.04%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"San Diego State Aztecs",Round_of_32:'99.76%',Sweet_Sixteen:'0.13%',Elite_Eight:'0.01%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Clemson Tigers",Round_of_32:'22.65%',Sweet_Sixteen:'4.38%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Colgate Raiders",Round_of_32:'9.97%',Sweet_Sixteen:'1.81%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Longwood Lancers",Round_of_32:'2.17%',Sweet_Sixteen:'1.22%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Yale Bulldogs",Round_of_32:'0.39%',Sweet_Sixteen:'0.37%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Texas A&M Aggies",Round_of_32:'4.16%',Sweet_Sixteen:'0.14%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Colorado State Rams",Round_of_32:'82.88%',Sweet_Sixteen:'0.11%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"South Carolina Gamecocks",Round_of_32:'89.13%',Sweet_Sixteen:'0.02%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Florida Atlantic Owls",Round_of_32:'99.32%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Mississippi State Bulldogs",Round_of_32:'74.82%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Kansas Jayhawks",Round_of_32:'36.03%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Michigan State Spartans",Round_of_32:'25.18%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Texas Longhorns",Round_of_32:'17.12%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Oregon Ducks",Round_of_32:'10.87%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Washington State Cougars",Round_of_32:'5.44%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"TCU Horned Frogs",Round_of_32:'2.65%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Charleston Cougars",Round_of_32:'1.93%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"South Dakota State Jackrabbits",Round_of_32:'0.93%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Northwestern Wildcats",Round_of_32:'0.68%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Wisconsin Badgers",Round_of_32:'0.65%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"UAB Blazers",Round_of_32:'0.24%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"NC State Wolfpack",Round_of_32:'0.11%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
      {name:"Duquesne Dukes",Round_of_32:'0.03%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
