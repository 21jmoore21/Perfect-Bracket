...
function find_winner(){
    ...
    if (study_year == 2023){
        ...
        var team_stats = [{name:"Houston Cougars",Round_of_32:'100.0%',Sweet_Sixteen:'99.16%',Elite_Eight:'64.4%',Final_Four:'62.68%',Championship:'44.48%',Champion:'32.58%'}, 
        {name:"Arizona Wildcats",Round_of_32:'99.96%',Sweet_Sixteen:'99.53%',Elite_Eight:'90.33%',Final_Four:'89.99%',Championship:'43.51%',Champion:'25.32%'}, 
        {name:"BYU Cougars",Round_of_32:'99.93%',Sweet_Sixteen:'71.44%',Elite_Eight:'71.2%',Final_Four:'60.52%',Championship:'47.35%',Champion:'19.36%'}, 
        {name:"Purdue Boilermakers",Round_of_32:'100.0%',Sweet_Sixteen:'96.78%',Elite_Eight:'88.51%',Final_Four:'76.48%',Championship:'26.33%',Champion:'9.46%'}, 
        {name:"North Carolina Tar Heels",Round_of_32:'100.0%',Sweet_Sixteen:'99.22%',Elite_Eight:'98.0%',Final_Four:'25.04%',Championship:'11.86%',Champion:'5.81%'}, 
        {name:"Baylor Bears",Round_of_32:'99.26%',Sweet_Sixteen:'73.13%',Elite_Eight:'31.16%',Final_Four:'29.13%',Championship:'9.28%',Champion:'3.69%'}, 
        {name:"Auburn Tigers",Round_of_32:'100.0%',Sweet_Sixteen:'28.54%',Elite_Eight:'28.21%',Final_Four:'13.53%',Championship:'10.7%',Champion:'1.92%'}, 
        {name:"Kentucky Wildcats",Round_of_32:'92.22%',Sweet_Sixteen:'86.78%',Elite_Eight:'85.2%',Final_Four:'13.85%',Championship:'2.71%',Champion:'0.97%'}, 
        {name:"Alabama Crimson Tide",Round_of_32:'89.64%',Sweet_Sixteen:'89.24%',Elite_Eight:'8.46%',Final_Four:'8.4%',Championship:'1.4%',Champion:'0.34%'}, 
        {name:"Miami Hurricanes",Round_of_32:'99.87%',Sweet_Sixteen:'3.22%',Elite_Eight:'2.27%',Final_Four:'1.53%',Championship:'0.29%',Champion:'0.13%'}, 
        {name:"Indiana State Sycamores",Round_of_32:'69.53%',Sweet_Sixteen:'13.12%',Elite_Eight:'1.2%',Final_Four:'0.78%',Championship:'0.42%',Champion:'0.12%'}, 
        {name:"McNeese Cowboys",Round_of_32:'48.24%',Sweet_Sixteen:'15.85%',Elite_Eight:'0.73%',Final_Four:'0.61%',Championship:'0.23%',Champion:'0.08%'}, 
        {name:"Duke Blue Devils",Round_of_32:'51.76%',Sweet_Sixteen:'10.81%',Elite_Eight:'3.71%',Final_Four:'3.12%',Championship:'0.19%',Champion:'0.06%'}, 
        {name:"UMass Lowell River Hawks",Round_of_32:'36.44%',Sweet_Sixteen:'21.06%',Elite_Eight:'10.5%',Final_Four:'1.24%',Championship:'0.29%',Champion:'0.05%'}, 
        {name:"Samford Bulldogs",Round_of_32:'9.62%',Sweet_Sixteen:'6.39%',Elite_Eight:'0.71%',Final_Four:'0.49%',Championship:'0.12%',Champion:'0.04%'}, 
        {name:"High Point Panthers",Round_of_32:'64.19%',Sweet_Sixteen:'56.25%',Elite_Eight:'1.27%',Final_Four:'0.52%',Championship:'0.13%',Champion:'0.03%'}, 
        {name:"Oklahoma Sooners",Round_of_32:'90.38%',Sweet_Sixteen:'79.03%',Elite_Eight:'7.31%',Final_Four:'6.57%',Championship:'0.04%',Champion:'0.02%'}, 
        {name:"UConn Huskies",Round_of_32:'100.0%',Sweet_Sixteen:'88.54%',Elite_Eight:'0.56%',Final_Four:'0.38%',Championship:'0.05%',Champion:'0.01%'}, 
        {name:"Purdue Fort Wayne Mastodons",Round_of_32:'11.37%',Sweet_Sixteen:'9.58%',Elite_Eight:'2.65%',Final_Four:'0.07%',Championship:'0.01%',Champion:'0.01%'}, 
        {name:"Creighton Bluejays",Round_of_32:'99.43%',Sweet_Sixteen:'28.35%',Elite_Eight:'20.58%',Final_Four:'2.13%',Championship:'0.53%',Champion:'0.0%'}, 
        {name:"Nevada Wolf Pack",Round_of_32:'10.36%',Sweet_Sixteen:'10.15%',Elite_Eight:'0.99%',Final_Four:'0.96%',Championship:'0.05%',Champion:'0.0%'}, 
        {name:"Illinois Fighting Illini",Round_of_32:'88.63%',Sweet_Sixteen:'62.07%',Elite_Eight:'30.7%',Final_Four:'0.75%',Championship:'0.03%',Champion:'0.0%'}, 
        {name:"Kansas Jayhawks",Round_of_32:'99.99%',Sweet_Sixteen:'71.2%',Elite_Eight:'58.13%',Final_Four:'0.36%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Cincinnati Bearcats",Round_of_32:'85.58%',Sweet_Sixteen:'8.61%',Elite_Eight:'8.54%',Final_Four:'0.29%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"New Mexico Lobos",Round_of_32:'58.86%',Sweet_Sixteen:'0.43%',Elite_Eight:'0.22%',Final_Four:'0.22%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Tennessee Volunteers",Round_of_32:'63.56%',Sweet_Sixteen:'41.98%',Elite_Eight:'15.62%',Final_Four:'0.15%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"James Madison Dukes",Round_of_32:'98.73%',Sweet_Sixteen:'36.54%',Elite_Eight:'19.95%',Final_Four:'0.12%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Grand Canyon Lopes",Round_of_32:'70.19%',Sweet_Sixteen:'66.06%',Elite_Eight:'25.19%',Final_Four:'0.05%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Gonzaga Bulldogs",Round_of_32:'74.35%',Sweet_Sixteen:'21.97%',Elite_Eight:'9.94%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Morehead State Eagles",Round_of_32:'7.78%',Sweet_Sixteen:'4.61%',Elite_Eight:'4.43%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Ole Miss Rebels",Round_of_32:'25.65%',Sweet_Sixteen:'6.83%',Elite_Eight:'4.07%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Princeton Tigers",Round_of_32:'0.07%',Sweet_Sixteen:'0.02%',Elite_Eight:'0.02%',Final_Four:'0.01%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"San Diego State Aztecs",Round_of_32:'29.81%',Sweet_Sixteen:'26.74%',Elite_Eight:'2.15%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Dayton Flyers",Round_of_32:'79.99%',Sweet_Sixteen:'51.49%',Elite_Eight:'1.51%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Utah State Aggies",Round_of_32:'91.86%',Sweet_Sixteen:'0.77%',Elite_Eight:'0.69%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Clemson Tigers",Round_of_32:'41.93%',Sweet_Sixteen:'6.68%',Elite_Eight:'0.52%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Memphis Tigers",Round_of_32:'70.79%',Sweet_Sixteen:'32.62%',Elite_Eight:'0.32%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Colorado Buffaloes",Round_of_32:'74.97%',Sweet_Sixteen:'11.44%',Elite_Eight:'0.02%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Wisconsin Badgers",Round_of_32:'35.81%',Sweet_Sixteen:'31.1%',Elite_Eight:'0.01%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Wake Forest Demon Deacons",Round_of_32:'100.0%',Sweet_Sixteen:'11.46%',Elite_Eight:'0.01%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Villanova Wildcats",Round_of_32:'8.14%',Sweet_Sixteen:'0.01%',Elite_Eight:'0.01%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Utah Utes",Round_of_32:'20.01%',Sweet_Sixteen:'8.99%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Akron Zips",Round_of_32:'29.21%',Sweet_Sixteen:'6.9%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Colorado State Rams",Round_of_32:'30.47%',Sweet_Sixteen:'1.46%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"South Carolina Gamecocks",Round_of_32:'25.03%',Sweet_Sixteen:'1.21%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Nebraska Cornhuskers",Round_of_32:'86.59%',Sweet_Sixteen:'0.84%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"UC Irvine Anteaters",Round_of_32:'58.07%',Sweet_Sixteen:'0.52%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Marquette Golden Eagles",Round_of_32:'71.5%',Sweet_Sixteen:'0.43%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Florida Atlantic Owls",Round_of_32:'1.27%',Sweet_Sixteen:'0.42%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Mississippi State Bulldogs",Round_of_32:'0.74%',Sweet_Sixteen:'0.21%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Western Kentucky Hilltoppers",Round_of_32:'28.5%',Sweet_Sixteen:'0.18%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Weber State Wildcats",Round_of_32:'0.04%',Sweet_Sixteen:'0.04%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Ohio State Buckeyes",Round_of_32:'41.14%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Michigan State Spartans",Round_of_32:'14.42%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"St. John's Red Storm",Round_of_32:'13.41%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Oregon Ducks",Round_of_32:'0.57%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Providence Friars",Round_of_32:'0.13%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Lipscomb Bisons",Round_of_32:'0.01%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Norfolk State Spartans",Round_of_32:'0.0%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
        {name:"Southern Jaguars",Round_of_32:'0.0%',Sweet_Sixteen:'0.0%',Elite_Eight:'0.0%',Final_Four:'0.0%',Championship:'0.0%',Champion:'0.0%'}, 
